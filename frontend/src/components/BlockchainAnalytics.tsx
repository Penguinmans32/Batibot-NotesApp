  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark-light">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="bg-background-card dark:bg-background-dark-card rounded-3xl p-6 shadow-2xl border border-secondary/20 dark:border-text-dark-secondary/20 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <button
                onClick={() => navigate('/dashboard')}
                className="p-2 hover:bg-secondary/10 dark:hover:bg-text-dark-secondary/10 rounded-xl transition-colors"
                title="Back to Dashboard"
              >
                <ArrowLeft className="w-6 h-6 text-text-primary dark:text-text-dark-primary" />
              </button>
            ...
            <div className="flex items-center space-x-3">
              <ThemeToggle />
              {wallet && (
                <div className="bg-green-100 dark:bg-green-900/20 px-4 py-2 rounded-xl border border-green-200 dark:border-green-700">
        ...
        {analytics?.totalTransactions === 0 ? (
          /* Empty State */
          <div className="bg-background-card dark:bg-background-dark-card rounded-3xl p-12 shadow-2xl border border-secondary/20 dark:border-text-dark-secondary/20 text-center">
            ...
            <button
              onClick={() => navigate('/dashboard')}
              className="bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl"
            >
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {/* Total ADA Spent */}
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-3xl p-6 border border-green-200 dark:border-green-700/50 shadow-xl">
                ...
                <h3 className="text-green-800 dark:text-green-300 font-semibold mb-1">Total ADA Invested</h3>
              ...
              {/* Total Transactions */}
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-3xl p-6 border border-blue-200 dark:border-blue-700/50 shadow-xl">
                <div className="flex items-center justify-between mb-4">
                ...
                <h3 className="text-blue-800 dark:text-blue-300 font-semibold mb-1">Blockchain Transactions</h3>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-3xl p-6 border border-purple-200 dark:border-purple-700/50 shadow-xl">
                ...
                <h3 className="text-purple-800 dark:text-purple-300 font-semibold mb-1">Avg Security Level</h3>
              ...
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-3xl p-6 border border-orange-200 dark:border-orange-700/50 shadow-xl">
                <div className="flex items-center justify-between mb-4">
                ...
                <h3 className="text-orange-800 dark:text-orange-300 font-semibold mb-1">Highest Security</h3>
                ...
                <p className="text-orange-700 dark:text-orange-400 text-sm mt-2 truncate">
            ...
            <div className="bg-background-card dark:bg-background-dark-card rounded-3xl p-6 shadow-2xl border border-secondary/20 dark:border-text-dark-secondary/20 mb-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-text-primary dark:text-text-dark-primary flex items-center space-x-2">
              ...
              {transactions.length === 0 ? (
                ...
                <div className="space-y-4">
                  {transactions.slice(0, 5).map((tx) => (
                    <div key={tx.id} className="bg-secondary/5 dark:bg-text-dark-secondary/5 rounded-xl p-4 border border-secondary/10 dark:border-text-dark-secondary/10">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Action Breakdown */}
              <div className="bg-background-card dark:bg-background-dark-card rounded-3xl p-6 shadow-2xl border border-secondary/20 dark:border-text-dark-secondary/20">
                <h2 className="text-xl font-bold text-text-primary dark:text-text-dark-primary mb-6 flex items-center space-x-2">
            ...
            {/* Bottom Stats */}
            <div className="mt-8 bg-gradient-to-r from-primary/10 to-purple-500/10 dark:from-primary/5 dark:to-purple-500/5 rounded-3xl p-6 border border-primary/20 dark:border-primary/10">
