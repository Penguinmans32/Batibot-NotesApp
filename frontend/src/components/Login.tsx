...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-background-dark flex items-center justify-center p-2 sm:p-4 relative overflow-hidden theme-transition">
      {/* Animated Background */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-2 p-2 sm:p-4 lg:p-8 flex flex-col justify-center">
              <div className="text-center mb-6 sm:mb-8 lg:mb-10">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-text-primary dark:text-text-dark-primary mb-2 sm:mb-3">
                  Welcome Back
                </h1>
                <p className="text-text-secondary dark:text-text-dark-secondary text-base sm:text-lg lg:text-xl">
              ...
              <div className="relative flex items-center justify-center my-4 sm:my-6">
                ...
                <div className="relative bg-background-card dark:bg-background-dark-card px-6">
                  <span className="text-text-light dark:text-text-dark-secondary font-medium text-sm sm:text-base lg:text-lg">or</span>
                </div>
              </div>

              {/* Google Login Button (moved below form) */}
              <button
