        ...
        <div className="bg-background-card backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-background-light">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary hover:bg-primary-dark disabled:bg-secondary rounded-xl py-4 text-white font-semibold text-lg transition-all duration-300 hover:shadow-lg disabled:cursor-not-allowed"
            >
              {loading ? (
