...
import { Eye, EyeOff, Mail, Lock, Sparkles, Star, Shield, Users, Type } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-4xl">
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 animate-float">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col justify-center p-6 lg:border-r border-white/20">
              <div className="mb-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">by Team Batibot</p>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-white font-semibold">Rich Text Editor</p>
                      <p className="text-white/70 text-sm">Format your notes with this powerful tool</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Your notes are encrypted and protected</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Share and collaborate with your team</p>
                    </div>
                  </div>
                </div>
              </div>
