...
import { Eye, EyeOff, Mail, Lock, User, Sparkles, Star, FileText, Users, Shield, CheckCircle } from 'lucide-react'; // Add CheckCircle
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-background-light flex items-center justify-center p-4">
        <div className="bg-background-card rounded-3xl p-8 shadow-xl border border-secondary/10 max-w-md w-full text-center">
          <div className="mb-6">
            ...
            <p className="text-text-secondary">
              Your account has been created with email: <span className="font-semibold text-text-primary">{email}</span>
            </p>
          </div>
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-xl p-4 mb-6">
            ...
            <p className="text-text-secondary text-sm">
              You'll be redirected to the login page in a few seconds to sign in with your new account.
            </p>
          </div>
          ...
          <button
            ...
            className="w-full bg-primary hover:bg-primary-light rounded-xl py-3 text-white font-semibold transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl"
          >
            Continue to Login
          </button>
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 lg:px-16 xl:px-20 text-white">
          ...
          <div className="mb-8">
            ...
            <p className="text-xl xl:text-2xl text-white/90 leading-relaxed mb-8">
              Join thousands of users who trust our platform for their note-taking needs. Start your journey today!
            </p>
          </div>
          ...
          <div className="bg-background-card rounded-3xl p-8 shadow-xl border border-secondary/10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-text-secondary text-base lg:text-lg">
                Join us and start taking amazing notes
              </p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-background-light border rounded-xl pl-12 pr-12 py-3.5 text-text-primary placeholder-text-secondary focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 ${
                      confirmPassword && password !== confirmPassword 
                        ? 'border-error focus:ring-error' 
                        : confirmPassword && password === confirmPassword
                        ? 'border-green-500 focus:ring-green-500'
                        : 'border-secondary/20 focus:ring-primary'
                    }`}
                  ...
                  <div className="flex items-center space-x-2 mt-1">
                    {password === confirmPassword ? (
                      ...
                      <>
                        ...
                        <span className="text-error text-xs font-medium">Passwords don't match</span>
                      </>
                    )}
                  </div>
                )}
